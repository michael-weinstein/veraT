...
def main():
    ...
    #AddRNASupport
    addRNASupportData = workFlows.getRNASupportVCF(jobList, tumorSampleName, tumorSampleName + "RNA", emailAddress = args.email, clobber = combineSomaticVariantsJob.clobber, outputDir = outputDir, combineSomaticsJob = combineSomaticVariantsJob, rnaVariantCallJob = jointGenotypeRNA, mock = args.mock)
